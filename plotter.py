...
tempF = []
pressure = []
arduinoData = serial.Serial('com11',
                            115200)  # Creating our serial object named arduinoData
...
def makeFig():  # Create a function that makes our desired plot
    ...
    plt.ylim(93450,
             93525)  # Set limits of second y axis- adjust to readings you are getting
